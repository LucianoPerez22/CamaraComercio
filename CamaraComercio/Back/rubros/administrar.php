    ...
    <div class="container" >
        <div class="row mt-5 d-flex justify-content-center">
            <div class="card w-40 border border-dark shadow p-3 mb-5 bg-white rounded">
                <h3 class="card-header text-white border border-dark shadow p-3 mb-2 rounded bg-primary">Administrar Rubros</h3>
                <div class="col-2">
                ...
                <table id="tabla" class="display" width="100%" cellspacing="0" >
                    ...
                    <?php
                        ...
                        $query = mysqli_query($conn, "SELECT subrubro.id, subrubro.id_rubro, subrubro.nombre AS subnombre, rubro.nombre FROM subrubro  INNER JOIN rubro ON subrubro.id_rubro=rubro.id ORDER BY subrubro.nombre ASC");
